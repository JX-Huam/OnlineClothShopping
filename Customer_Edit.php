...
<body>
    <div class="container my-5">
        ...
        <form method="post" action="Customer_Update.php" onsubmit="return validate()">
            <table class="table">
                <?php
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    <tr>
                        ...
                        <td><input type='text' name='shippingAddr' value='$row[shippingAddress]'></td>
                    </tr>
                    <tr>
                        <th>City:</th>
                    ...
                    <tr>
                        ...
                        <td><input type='password' name='confirmPassword' value='$row[password]'></td>
                    </tr>
                    <tr>
        ...
        <div style="text-align: center;">
            <a class="btn btn-primary" href="Customer_Detail.php" role="button">Back to Information Detail</a>
        </div>
    </div>
</body>
</html>
